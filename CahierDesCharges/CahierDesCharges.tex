...
\newpage\clearpage\pagenumbering{arabic}
	...
	\section{Organigramme}
		\centerline{\includegraphics[width = 12cm,height = 10cm]{OrganigrammeV3.jpeg}}
	...
	\section{Autres aspects du projet}
		\subsection{Estimation des coûts du projet}
			\begin{tabular}{|c|c|c|c|c|}
				\hline Module & complexité & Nombre de lignes & Temps & Affectation\\
				\hline Interface &  &  &  & \\
				\hline Gestion de la validité des données &  &  &  & \\
				\hline Module d'initialisation &  &  &  & \\
